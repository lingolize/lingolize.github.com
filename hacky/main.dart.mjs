...
_1936: (x0,x1,x2) => x0.transaction(x1,x2),
_1937: (x0,x1) => x0.objectStore(x1),
_1938: x0 => new Blob(x0),
_1939: (x0,x1,x2) => x0.add(x1,x2),
_1940: (x0,x1) => x0.get(x1),
_1941: x0 => x0.abort(),
_1942: x0 => x0.close(),
_1945: (x0,x1) => x0.objectStore(x1),
_1946: (x0,x1) => x0.index(x1),
_1947: x0 => x0.openKeyCursor(),
_1948: (x0,x1) => x0.objectStore(x1),
_1949: (x0,x1) => x0.index(x1),
_1950: (x0,x1) => x0.getKey(x1),
_1951: (x0,x1) => x0.objectStore(x1),
_1952: (x0,x1) => ({name: x0,length: x1}),
_1953: (x0,x1) => x0.put(x1),
_1954: (x0,x1) => x0.objectStore(x1),
_1955: (x0,x1) => x0.get(x1),
_1956: (x0,x1) => x0.objectStore(x1),
_1957: (x0,x1) => x0.openCursor(x1),
_1959: (x0,x1) => x0.objectStore(x1),
_1960: x0 => globalThis.IDBKeyRange.only(x0),
_1961: (x0,x1,x2) => x0.put(x1,x2),
_1962: (x0,x1) => x0.update(x1),
_1963: (x0,x1) => x0.objectStore(x1),
_1964: (x0,x1) => x0.update(x1),
_1965: (x0,x1) => x0.objectStore(x1),
_1966: (x0,x1) => x0.objectStore(x1),
_1967: (x0,x1) => x0.delete(x1),
_1968: (x0,x1) => x0.update(x1),
_1969: (x0,x1) => x0.objectStore(x1),
_1970: (x0,x1) => x0.delete(x1),
_1971: (x0,x1) => x0.objectStore(x1),
_1972: (x0,x1) => x0.delete(x1),
_1975: x0 => x0.name,
_1976: x0 => x0.length,
_1978: x0 => x0.createSyncAccessHandle(),
_1979: (x0,x1) => x0.truncate(x1),
_1980: (x0,x1) => x0.truncate(x1),
_1981: x0 => x0.close(),
_1982: x0 => x0.close(),
_1983: x0 => x0.flush(),
_1984: x0 => x0.getSize(),
_1985: x0 => x0.flush(),
_1986: (x0,x1) => x0.truncate(x1),
_1988: x0 => globalThis.BigInt(x0),
_1989: x0 => globalThis.Number(x0),
_1992: x0 => globalThis.Object.keys(x0),
_1997: (x0,x1) => globalThis.WebAssembly.instantiateStreaming(x0,x1),
_1998: x0 => x0.call(),
_1999: x0 => x0.exports,
_2000: x0 => x0.instance,
_2004: x0 => x0.buffer,
_2005: () => globalThis.WebAssembly.Global,
_2008: () => globalThis.navigator,
_2009: x0 => x0.getDirectory(),
_2010: (x0,x1) => x0.read(x1),
_2011: (x0,x1,x2) => x0.read(x1,x2),
_2012: (x0,x1) => x0.write(x1),
_2013: (x0,x1,x2) => x0.write(x1,x2),
_2014: x0 => ({create: x0}),
_2015: (x0,x1,x2) => x0.getDirectoryHandle(x1,x2),
_2016: () => new XMLHttpRequest(),
...
_2037: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
_2038: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
...
_2070: x0 => x0.pop(),
_2074: (x0,x1,x2) => x0[x1] = x2,
_2076: o => o === undefined,
_2077: o => typeof o === 'boolean',
_2078: o => typeof o === 'number',
_2080: o => typeof o === 'string',
_2083: o => o instanceof Int8Array,
_2084: o => o instanceof Uint8Array,
_2085: o => o instanceof Uint8ClampedArray,
_2086: o => o instanceof Int16Array,
_2087: o => o instanceof Uint16Array,
_2088: o => o instanceof Int32Array,
_2089: o => o instanceof Uint32Array,
_2090: o => o instanceof Float32Array,
_2091: o => o instanceof Float64Array,
_2092: o => o instanceof ArrayBuffer,
_2093: o => o instanceof DataView,
_2094: o => o instanceof Array,
...
_2119: l => arrayFromDartList(Array, l),
_2120:       (s, length) => {
        if (length == 0) return '';
...
_2129: (o, p) => o[p],
_2130: (o, p, v) => o[p] = v,
_2131: (o, m, a) => o[m].apply(o, a),
_2133: o => String(o),
_2134: (p, s, f) => p.then(s, f),
_2135: s => {
      if (/[[\]{}()*+?.\\^$|]/.test(s)) {
          s = s.replace(/[[\]{}()*+?.\\^$|]/g, '\\$&');
      }
...
_2152: (o, p) => o[p],
_2153: (o, p, v) => o[p] = v,
_2155: (x0,x1,x2) => globalThis.Atomics.wait(x0,x1,x2),
_2157: (x0,x1,x2) => globalThis.Atomics.notify(x0,x1,x2),
_2158: (x0,x1,x2) => globalThis.Atomics.store(x0,x1,x2),
_2159: (x0,x1) => globalThis.Atomics.load(x0,x1),
_2160: () => globalThis.Int32Array,
_2162: () => globalThis.Uint8Array,
_2164: () => globalThis.DataView,
_2167: x0 => x0.byteLength,
_2217: () => globalThis.window.flutterCanvasKit,
_2270: (x0,x1) => x0.withCredentials = x1,
_2272: x0 => x0.responseURL,
_2273: x0 => x0.status,
_2274: x0 => x0.statusText,
_2276: (x0,x1) => x0.responseType = x1,
_2277: x0 => x0.response,
_4089: () => globalThis.window,
_4419: x0 => x0.localStorage,
_4559: x0 => x0.storage,
_4597: x0 => x0.data,
_4628: x0 => x0.port1,
_4629: x0 => x0.port2,
_4635: (x0,x1) => x0.onmessage = x1,
_4721: x0 => x0.port,
_4762: x0 => x0.length,
_6868: () => globalThis.document,
_7312: (x0,x1) => x0.id = x1,
_7339: x0 => x0.children,
_10885: x0 => x0.result,
_10886: x0 => x0.error,
_10897: (x0,x1) => x0.onupgradeneeded = x1,
_10899: x0 => x0.oldVersion,
_10989: x0 => x0.key,
_10990: x0 => x0.primaryKey,
_10992: x0 => x0.value
    };
